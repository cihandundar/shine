...
<body>
    ...
    <div class="grid gap-5 grid-cols-12 bg-[#001315] h-screen">
        <div class="lg:col-span-6 col-span-12 flex flex-col items-center justify-center w-full p-30">
            ...
            <form method="POST" action="{{ route('auth.login.post') }}" class="w-full">
                ...
                <div class="relative w-full mb-5">
                    ...
                    <label for="email"
                        class="text-white capitalize absolute left-4 top-4 text-base pointer-events-none bg-[#001315]/70 rounded px-1 transition-all duration-200 ease-in-out
        ...
        peer-focus:-top-2 peer-focus:left-3 peer-focus:text-xs peer-focus:scale-90 peer-focus:bg-[#001315]/70 peer-focus:px-1
        peer-[&:not(:placeholder-shown)]:-top-2 peer-[&:not(:placeholder-shown)]:left-3 peer-[&:not(:placeholder-shown)]:text-xs
        peer-[&:not(:placeholder-shown)]:scale-90 peer-[&:not(:placeholder-shown)]:bg-[#001315]/70 peer-[&:not(:placeholder-shown)]:px-1">
                        Email
                    </label>
                </div>
